...
<?php $usuario="Jorge Padilla Sanchez";?>
<div id="app">
  <nav id="navbar-main" class="navbar is-fixed-top">
    <div class="navbar-brand">
      ...
      <!--<div class="navbar-item has-control">
        <div class="control"><input placeholder="Buscar en todo el Sistema..." class="input"></div>
      </div> -->
        ...
        <div class="navbar-item has-dropdown has-dropdown-with-icons has-divider has-user-avatar is-hoverable">
          <a class="navbar-link is-arrowless">
            <div class="is-user-avatar">
              <img src="https://avatars.dicebear.com/v2/initials/john-doe.svg" alt="<?php echo $usuario?>">
            </div>
            <div class="is-user-name"><span><?php echo $usuario?></span></div>
