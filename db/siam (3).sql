...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-04-2023 a las 21:48:11
...
(2, '1234567890', 1, 3740, 500000, '0000-00-00', 1, 500000, '1000', '4'),
(3, '1234560', 1, 18700, 488820, '2023-04-06', 1, 500000, '5000', '4'),
(10, '2562', 2, 32025.62, 100000, '2023-04-22', 1, 100000, '8563', '4'),
(11, '467894321', 2, 372, 67974.38, '2023-04-08', 2, 100000, '100', '4');
...
(2, 'PROGRAMA DE EDUCACION', '210000008', 100000);
...
--
ALTER TABLE `compras_combustible`
  MODIFY `id_compra_combustible` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
